# Trend Eng - 트렌드 기반 맞춤형 영어 학습 📚

최신 트렌드와 사용자의 관심사를 반영한 맞춤형(Customized) 영어 학습을 제공하는 AI 기반 웹 애플리케이션입니다.

## 🚀 주요 기능

1. **주제 및 트렌드 기반 학습**: 사용자가 입력한 관심 주제(예: IT 트렌드, 최신 뉴스, 취미 등)에 맞춰 실시간 맞춤형 학습 문장 생성.
