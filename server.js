...
3. "sentence_structure": 문장의 형식(1~5형식)과 주요 문장 성분(주어, 동사, 목적어, 보어, 수식어, 절 등)을 매우 상세하게 분석해 주세요. 각 성분이 문장에서 어떤 역할을 하는지 구체적으로 명시해야 합니다. (예: "3형식 / 주어: I, 동사: love, 목적어: coding (동명사), 수식어: in JavaScript")
4. "explanation": AI 학습 가이드로서, 이 문장을 완벽히 이해하기 위한 핵심 문법, 구문 분석, 해석의 핵심 포인트 및 한국어와 영어의 구조적 차이점을 포함하여 초보자도 쉽게 이해할 수 있도록 친절하고 자세하게 설명해 주세요.
...
[
  {
    ...
    "sentence_structure": "3형식 / 주어: I, 동사: love, 목적어: coding (동명사), 수식어: in JavaScript (전치사구), 종속절: because it is versatile (이유의 부사절)",
    "explanation": "이 문장은 주절과 'because'로 시작하는 부사절로 구성된 복문입니다. 주절 'I love coding in JavaScript'는 3형식 구조로, 'coding'이라는 동명사가 'love'의 목적어 역할을 합니다. 'in JavaScript'는 어떤 분야에서 코딩하는지를 설명하는 수식어입니다. 부사절 'because it is versatile'은 주절에 대한 이유를 보충 설명하며, 'it'은 앞의 'JavaScript'를 가리키는 대명사입니다. 해석할 때는 주절을 먼저 해석하고 because 부분을 연결하여 자연스러운 원인-결과 문장을 만듭니다.",
