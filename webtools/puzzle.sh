...
/home/lmo0317ea/.nvm/versions/node/v22.22.1/bin/gemini -m "gemini-3.1-flash-lite-preview" -y "/puzzle ${TOPIC} ${COUNT}개 생성해서 운영 서버(https://minohlee.mooo.com)에 반영해줘. 모든 결과 보고는 텔레그램으로 전송해줘."
