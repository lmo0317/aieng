...
/home/lmo0317ea/.nvm/versions/node/v22.22.1/bin/gemini -m "gemini-3.1-flash-lite-preview" -y "/puzzle ${TOPIC} ${COUNT}개 생성해서 운영 서버(aieng.cafe24app.com)에 반영해줘. 모든 결과 보고는 텔레그램으로 전송해줘. (주의: 제목은 반드시 '[대주제]: [소주제]' 형식을 지켜야 하며, 'Vocabulary Challenge'나 '영어 퀴즈'를 제목 끝에 붙이지 마십시오.)"
