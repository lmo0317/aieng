...
/home/lmo0317ea/.nvm/versions/node/v22.22.1/bin/gemini -y "/popsong ${ARTIST} - ${SONG}. 가사 전체를 분석해서 SKILL.md 지침에 따라 1타 강사 스타일로 아주 자세하고 꼼꼼하게 만들어줘. 문장 구조 분석과 뉘앙스 설명(4문장 이상)을 완벽하게 넣고, aieng.cafe24.com 서버 저장과 텔레그램 결과 보고까지 완벽하게 마쳐줘."
