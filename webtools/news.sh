...
/home/lmo0317ea/.nvm/versions/node/v22.22.1/bin/gemini -m "gemini-3.1-pro-preview" -y "/news 총합 ${COUNT}개만 만들어줘. 트렌드는 ${TOPIC} 중에서 선정하고 설명은 SKILL.md 지침에 따라 문장당 5문장 이상 아주 자세하고 꼼꼼하게 넣어줘. 반드시 기사당 10문장을 꽉 채워야 하며, aieng.cafe24.com 서버 반영과 텔레그램 결과 보고까지 완벽하게 마쳐줘."
